...
var backup_1 = require("./tasks/backup");
var restore_1 = require("./tasks/restore");
var setup_1 = require("./tasks/setup");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var taskName, taskArgs, task, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    task = new tasks[taskName]();
                    return [4 /*yield*/, task.execute(taskArgs[0])];
                case 2:
                    result = _a.sent();
