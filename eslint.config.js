...
export default [
    {
        ignores: ['.next/**/*', '__tests__/**/*', 'lambdas/**/*', 'eslint.config.js', 'check-case-sensitivity.js', '*.cjs', '*.json', 'next.config.mjs', 'load-env.mjs', '.yarn/releases/**/*', 'dbsetup.js', 'jest.polyfills.js', 'migrate.js', 'dist/**/*'],
    },
