                ...
                <Accordion>
                    ...
                    <Accordion.Collapse eventKey="2">
                        <ListGroup>
                            ...
                            <Item key="sticky">
                                <b>Sticky -</b> the gall exudes some kind of sticky fluid. In some cases this fluid is attractive
                                to ants and is often visible as a wet sheen in photos, but ideally it should be tested by touch in
                                the field.
                            </Item>
                        </ListGroup>
                    </Accordion.Collapse>
                    ...
                    <Accordion.Collapse eventKey="5">
                        <ListGroup>
                            <Item key="single">
                                <b>Single -</b> the gall&apos;s structure is built to accomodate only a single space for a
                                gall-inducer larva, pupa, or adult.
                            </Item>
                            <Item key="multiple">
                                <b>Multiple -</b> the gall&apos;s structure is built to accomodate spaces for multiple
                                gall-inducer larvae, pupae, or adults.
                            </Item>
                            <Item>
